...
public class Exemplo01 {
    public static void main(String[] args) {
        ...
        //A declaração de um vetor em Java começa com a especificação do tipo de dado que o vetor vai armazenar, seguido por colchetes [] para
        // indicar sua natureza de vetor.
